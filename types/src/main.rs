...
fn main() {
    ...
    */
    ...
    let float: f32 = 1.234_567_89;
    println!("Value: {}", float);

    let float: f32 = 1.234_567_89;
    println!("Value: {}", float);

    let float = 1.23456789f32;
    println!("Value: {}", float);

    let float = 1.234_567_89f32;
    println!("Value: {}", float);
    ...
    let float: f64 = 1.23456789;
    println!("Value: {}", float);

    let float: f64 = 1.234_567_89;
    println!("Value: {}", float);

    let float = 1.23456789f64;
    println!("Value: {}", float);

    let float = 1.234_567_89f64;
    println!("Value: {}", float);
